...
extensions = [
    Extension(
        name="aifeynman._symbolic_regress_mdl3",
        sources=["aifeynman/symbolic_regress_mdl3.f90"],
    )
]
...
sr1 = Extension(
    name='aifeynman._symbolic_regress1',
    sources=['aifeynman/symbolic_regress1.f90'],
)

sr2 = Extension(
    name='aifeynman._symbolic_regress2',
    sources=['aifeynman/symbolic_regress2.f90'],
)

sr3 = Extension(
    name='aifeynman._symbolic_regress3',
    sources=['aifeynman/symbolic_regress3.f90'],
)

sr_mdl_mult = Extension(
    name='aifeynman._symbolic_regress_mdl3',
    sources=['aifeynman/symbolic_regress_mdl3.f90'],
)

sr_mdl_plus = Extension(
    name='aifeynman._symbolic_regress_mdl2',
    sources=['aifeynman/symbolic_regress_mdl2.f90'],
)

sr_mdl4 = Extension(
    name='aifeynman._symbolic_regress_mdl4',
    sources=['aifeynman/symbolic_regress_mdl4.f90'],
)

sr_mdl5 = Extension(
    name='aifeynman._symbolic_regress_mdl5',
    sources=['aifeynman/symbolic_regress_mdl5.f90'],
)
